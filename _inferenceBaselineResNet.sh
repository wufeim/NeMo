#!/bin/bash
#PBS -N TrainTrainBase
#PBS -S /bin/bash
#PBS -l nodes=1:ppn=28:gpus=1:nvidiaRTX3090,mem=20gb,walltime=24:00:00
#PBS -q default-cpu
#PBS -m a
...
do
    ...
    python scripts/inference.py \
        ...
        --save_dir exp/pose_estimation_3d_resnet50_general_$CATEGORY \
        --checkpoint exp/pose_estimation_3d_resnet50_general_$CATEGORY/ckpts/model_200.pth
done
# Print end time
end=$(date)
echo "End time: $end" 
